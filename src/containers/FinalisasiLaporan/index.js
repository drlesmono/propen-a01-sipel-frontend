...
class FinalisasiLaporan extends Component {
    ...
    async handleSubmit(event) {
        ...
        try {
            ...
            dataReport.append("reportType", this.state.reportTarget.reportType);
            ...
            if(this.state.isInstallationReport){
                ...
                const dataInstallationReport = {
                    ...
                    irNum: null,
                    notes: "Installation Report telah difinalisasi",
                ...
                const dataMaintenanceReport = {
                    ...
                    mrNum: null,
                    notes: "Maintenance Report telah difinalisasi",
                ...
                const dataBastReport = {
                    idBast: null,
                    bastNum: null,
                    dateHandover: this.state.bastTarget.dateHandover,
                    startPeriod: this.state.bastTarget.startPeriod,
                    endPeriod: this.state.bastTarget.endPeriod,
                    notes: "BAST telah difinalisasi",
                    idMaintenance: this.state.bastTarget.idMaintenance,
                    idOrderMs: null,
                    idOrderPi: this.state.bastTarget.idOrderPi
                }
    ...
    getToDownloadBast(report){
        const bastList = this.state.listBast;
        //console.log(bastList);
        var tipe;
        const id = report.idReport;
        var bast;
                                ...
                                <Table borderless responsive="xl" size="sm">
                                    <tr>
                                        ...
                                        <td><p className="d-flex">
                                            ...
                                            {isBastReport ? this.getOrder(reportTarget).noPO : ""}
                                        </p></td>
                                    </tr>
                                    <tr>
